...
MyApplet.prototype = {
  ...
  _setup: function() {
    ...
    this._griveMenu = new St.BoxLayout({name: 'griveMenu', reactive: true, vertical: true});
    ...
    global.reparentActor(new PopupMenu.PopupSeparatorMenuItem().actor, this._griveMenu);
    
    let configureMenue = new PopupMenu.PopupIconMenuItem(_("Configure"), "preferences-system", St.IconType.SYMBOLIC);
    configureMenue.connect("activate", Lang.bind(this, function(){
                                         this.menu.close();
                                         Util.spawnCommandLine("cinnamon-settings applets grive-sync@t3pleni9.com");
                                       }));
    configureMenue.actor_can_focus = true;
    global.reparentActor(configureMenue.actor, this._griveMenu);    
  },
